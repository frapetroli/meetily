...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api::api_list_vocabularies,
            api::api_create_vocabulary,
            api::api_update_vocabulary,
            api::api_delete_vocabulary,
            api::api_get_active_vocabulary_id,
            api::api_save_active_vocabulary_id,
